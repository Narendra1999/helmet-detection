...
DIRECTORY = r"C:\Users\dell\Desktop\PROJECT LAB\helmet-detector\dataset"
...
labels = []         # This contain that the image is "with_helmet" or "without_helmet"
...
# This will converts our lables ("with_helmet" or "without_helmet") to
...
# Here a dense Layer with 2 Nurones ("with_helmet" or "without_helmet")
...
# Save the Model
print("INFORMATION :- Saving the Helmet Detector Model ....")
